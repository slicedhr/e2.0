...
(function () {
         ...
         *
         */
        angular.module('login').factory('AuthService', AuthService);
        ...
        function AuthService($rootScope, $mdDialog, $http, AppService) {
                ...
                AuthBase.logout = function () {
                        ...
                        var confirm = $mdDialog.confirm().title('Confirmación').content('¿Realmente deseas salir?').ok('Confirmar').cancel('Cancelar');
