...
(function () {
    ...
    /**
     * @ngdoc directive
     * @name enterprise.directive:resizable
     * @restrict EA
     * @element
     *
     * @description
     ...
     *
     */
    angular.module('enterprise').directive('resizable', resizable);
        ...
        return {
            ...
            link: function link(scope, element, attr) {
                ...
                var updateInfo = function updateInfo(e) {
                    ...
                    if (axis === 'x') info.width = parseInt(element[0].style[scope.rFlex ? flexBasis : 'width']);else info.height = parseInt(element[0].style[scope.rFlex ? flexBasis : 'height']);
                ...
                var dragStart = function dragStart(e, direction) {
                    dragDir = direction;
